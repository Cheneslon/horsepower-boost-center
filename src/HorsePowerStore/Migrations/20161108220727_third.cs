        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Intake = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarInstances_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarInstances_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarInstances_Engines_EngineId",
                        column: x => x.EngineId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CarInstanceId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_CarInstances_CarInstanceId",
                        column: x => x.CarInstanceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarMods", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarMods_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarInstances_ApplicationUserId",
                table: "CarInstances",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CarInstances_CarId",
                table: "CarInstances",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_CarInstances_EngineId",
                table: "CarInstances",
                column: "EngineId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_CarInstanceId",
                table: "Products",
                column: "CarInstanceId");
